...
<br><br><br><img src="jpeg/ダブルベーコン.jpg" width=350 height=250  alt="ハンバーガー">
<br><br><p>ナゲット15ピース</p><form action="/Enshu/HamburgerServlet"  method="post">
	<font size="3" >個数</font>
	<select name="kosuu">
...
<input type = "hidden" name="shohinName" value=" ナゲット15ピース"/>
